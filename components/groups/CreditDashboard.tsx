  ...
  return (
    <div className="space-y-4">
        ...
        <div className="marker-card p-4 space-y-4">
          <div className="flex items-center justify-between flex-wrap gap-2">
            <button
              ...
              className="flex items-center gap-1 font-graffiti text-xl text-asphalt hover:text-terracotta transition-colors"
            >
              {showPayForm ? (
      ...
      <div className="marker-card p-4">
        <h3 className="font-graffiti text-xl text-asphalt mb-3">Balances</h3>
        <p className="text-xs text-asphalt/50 font-body mb-3">
