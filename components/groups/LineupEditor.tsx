...
interface LineupEditorProps {
  groupId: string;
  members: MemberRow[];
  /** Fired after the lineup is successfully saved (e.g. to invalidate a preview). */
  onLineupSaved?: () => void;
}

/**
 * The crew's persistent rotation lineup — order players and toggle who's in.
 * Shared by the Rotation tab and the round-robin section of the create flow.
 * The saved order/active flags are what the round-robin slide runs over.
 */
export default function LineupEditor({ groupId, members, onLineupSaved }: LineupEditorProps) {
